...
#Setup
yarn snarkjs groth16 setup zk/board.r1cs zk/ptau/pot12_final.ptau zk/zkey/board_final.zkey
yarn snarkjs groth16 setup zk/shot.r1cs zk/ptau/pot12_final.ptau zk/zkey/shot_final.zkey

# # Generate reference zkey
yarn snarkjs zkey new zk/board.r1cs zk/ptau/pot12_final.ptau zk/zkey/board_0000.zkey
yarn snarkjs zkey new zk/shot.r1cs zk/ptau/pot12_final.ptau zk/zkey/shot_0000.zkey
...
# #  Verify zkey
yarn snarkjs zkey verify zk/board.r1cs zk/ptau/pot12_final.ptau zk/zkey/board_0003.zkey
yarn snarkjs zkey verify zk/shot.r1cs zk/ptau/pot12_final.ptau zk/zkey/shot_0003.zkey
...
yarn snarkjs zkey verify zk/board.r1cs zk/ptau/pot12_final.ptau zk/zkey/board_final.zkey
yarn snarkjs zkey verify zk/shot.r1cs zk/ptau/pot12_final.ptau zk/zkey/shot_final.zkey
